...
function getUserIP() {
 ...
 if (isset($_POST['username']) && isset($_POST['password']) ){
    ...
    $correct_password = 'Utnyttelsesgr@den123$';
    ...
    if(strcmp($password, $correct_password) == 0){
        ...
        echo 'Success!';
        $IP = getUserIP();
        error_log('POST opg 7 from IP: '. $IP . ' username: '. $username . ' password: '. $password );
        
        header('Location: oppgave7_complete_supershashaman2k.html');
        exit;
    }
    echo 'Ikke prøv deg...';
    exit;
